...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtAccretion : SgtBehaviour
	{
		/// <summary>The base color will be multiplied by this.</summary>
		[FormerlySerializedAs("color")] public Color Color = Color.white; public void SetColor(Color value) { Color = value; UpdateMaterial(); }

		/// <summary>The Color.rgb values are multiplied by this, allowing you to quickly adjust the overall brightness.</summary>
		[FormerlySerializedAs("brightness")] public float Brightness = 1.0f; public void SetBrightness(float value) { Brightness = value; UpdateMaterial(); }
		...
		[FormerlySerializedAs("renderQueue")] public SgtRenderQueue RenderQueue = SgtRenderQueue.GroupType.Transparent; public void SetRenderQueue(SgtRenderQueue value) { RenderQueue = value; UpdateMaterial(); }

		/// <summary>The texture applied to the disc, where the left side is the inside, and the right side is the outside.</summary>
		[FormerlySerializedAs("mainTex")] public Texture MainTex; public void SetMainTex(Texture value) { MainTex = value; UpdateMaterial(); }

		/// <summary>This allows you to set the mesh used to render the disc.</summary>
		[FormerlySerializedAs("mesh")] public Mesh Mesh; public void SetMesh(Mesh value) { Mesh = value; UpdateMesh(); }
		...
		[FormerlySerializedAs("segments")] public int Segments = 8; public void SetSegments(int value) { Segments = value; UpdateModels(); }

		/// <summary>Should the disc have a detail texture? For example, dust noise when you get close.</summary>
		[FormerlySerializedAs("detail")] public bool Detail; public void SetDetail(bool value) { Detail = value; UpdateMaterial(); }

		/// <summary>This allows you to set the detail texture that gets repeated on the disc surface.</summary>
		[FormerlySerializedAs("detailTex")] public Texture DetailTex; public void SetDetailTex(Texture value) { DetailTex = value; UpdateMaterial(); }

		/// <summary>The detail texture horizontal tiling.</summary>
		[FormerlySerializedAs("detailScaleX")] public float DetailScaleX = 1.0f; public void SetDetailScaleX(float value) { DetailScaleX = value; UpdateMaterial(); }

		/// <summary>The detail texture vertical tiling.</summary>
		[FormerlySerializedAs("detailScaleY")] public int DetailScaleY = 1; public void SetDetailScaleY(int value) { DetailScaleY = value; UpdateMaterial(); }

		/// <summary>The UV offset of the detail texture.</summary>
		[FormerlySerializedAs("detailOffset")] public Vector2 DetailOffset; public void SetDetailOffset(Vector2 value) { DetailOffset = value; UpdateMaterial(); }

		/// <summary>The scroll speed of the detail texture UV offset.</summary>
		[FormerlySerializedAs("detailSpeed")] public Vector2 DetailSpeed = new Vector2(1.0f, 1.0f); public void SetDetailSpeed(Vector2 value) { DetailSpeed = value; UpdateMaterial(); }

		/// <summary>The amount the detail texture is twisted around the disc.</summary>
		[FormerlySerializedAs("detailTwist")] public float DetailTwist; public void SetDetailTwist(float value) { DetailTwist = value; UpdateMaterial(); }

		/// <summary>The amount the twisting is pushed to the outer edge.</summary>
		[FormerlySerializedAs("detailTwistBias")] public float DetailTwistBias = 1.0f; public void SetDetailTwistBias(float value) { DetailTwistBias = value; UpdateMaterial(); }

		/// <summary>Enable this if you want the disc to fade out as the camera approaches.</summary>
		[FormerlySerializedAs("near")] public bool Near; public void SetNear(bool value) { Near = value; UpdateMaterial(); }
		...
		[FormerlySerializedAs("nearTex")] public Texture NearTex; public void SetNearTex(Texture value) { NearTex = value; UpdateMaterial(); }

		/// <summary>The world space distance the fade will begin from.</summary>
		[FormerlySerializedAs("nearDistance")] public float NearDistance = 1.0f; public void SetNearDistance(float value) { NearDistance = value; UpdateMaterial(); }
