...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtStarfieldNebula_Editor : SgtStarfield_Editor<SgtStarfieldNebula>
	{
		protected override void OnInspector()
		{
			...
			DrawDefault("StarTint", ref updateMeshesAndModels, "This allows you to control how much the underlying nebula pixel color influences the generated star color.\n\n0 = StarColors gradient will be used directly.\n\n1 = Colors will be multiplied together.");
			DrawDefault("StarBoost", ref updateMeshesAndModels, "Should the star color luminosity be boosted?");
