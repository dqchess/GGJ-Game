...
namespace SpaceGraphicsToolkit
{
		...
		where T : SgtStarfield
	{
		protected void DrawPointMaterial(ref bool updateMaterial)
		{
			...
			DrawDefault("ClampSize", ref updateMaterial, "Prevent the quads from being too small on screen?");
...
namespace SpaceGraphicsToolkit
{
	...
	public abstract class SgtStarfield : SgtQuads
	{
		...
		public bool ClampSize; public void SetClampSize(bool value) { ClampSize = value; }
		...
		public float ClampSizeMin = 10.0f; public void SetClampSizeMin(float value) { ClampSizeMin = value; }
