...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtTerrain_Editor : SgtEditor<SgtTerrain>
	{
		protected override void OnInspector()
		{
			...
			DrawDefault("CenterMesh", ref rebuild, "");
...
namespace SpaceGraphicsToolkit
{
	...
	public partial class SgtTerrain : SgtLinkedBehaviour<SgtTerrain>
	{
		...
		/// <summary>If you have a large planet then your terrain faces should be centered.</summary>
		...
		public SgtTerrainCompute.Output SampleLocalOutput(SgtVector3D localPoint)
		{
			...
			SgtTerrainCompute.SetDetail(MaskMap, DetailTiling, DetailMapA, DetailScaleA, DetailMapB, DetailScaleB);
