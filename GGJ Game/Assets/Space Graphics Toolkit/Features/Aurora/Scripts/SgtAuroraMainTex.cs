...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtAuroraMainTex : MonoBehaviour
	{
		...
		public int Width = 256; public void SetWidth(int value) { Width = value; UpdateTexture(); }
		...
		public int Height = 64; public void SetHeight(int value) { Height = value; UpdateTexture(); }

		/// <summary>The format of the generated texture.</summary>
		public TextureFormat Format = TextureFormat.ARGB32; public void SetFormat(TextureFormat value) { Format = value; UpdateTexture(); }

		/// <summary>The strength of the noise points.</summary>
		[Range(0.0f, 1.0f)] public float NoiseStrength = 0.75f; public void SetNoiseStrength(float value) { NoiseStrength = value; UpdateTexture(); }

		/// <summary>The amount of noise points.</summary>
		public int NoisePoints = 30; public void SetNoisePoints(int value) { NoisePoints = value; UpdateTexture(); }

		/// <summary>The random seed used when generating this texture.</summary>
		[SgtSeed] public int NoiseSeed; public void SetNoiseSeed(int value) { NoiseSeed = value; UpdateTexture(); }

		/// <summary>The transition style between the top and middle.</summary>
		public SgtEase.Type TopEase = SgtEase.Type.Quintic; public void SetTopEase(SgtEase.Type value) { TopEase = value; UpdateTexture(); }

		/// <summary>The transition strength between the top and middle.</summary>
		public float TopSharpness = 1.0f; public void SetTopSharpness(float value) { TopSharpness = value; UpdateTexture(); }

		/// <summary>The point separating the top from bottom.</summary>
		[Range(0.0f, 1.0f)] public float MiddlePoint = 0.25f; public void SetMiddlePoint(float value) { MiddlePoint = value; UpdateTexture(); }

		/// <summary>The base color of the aurora starting from the bottom.</summary>
		public Color MiddleColor = Color.green; public void SetMiddleColor(Color value) { MiddleColor = value; UpdateTexture(); }

		/// <summary>The transition style between the bottom and top of the aurora.</summary>
		public SgtEase.Type MiddleEase = SgtEase.Type.Exponential; public void SetMiddleEase(SgtEase.Type value) { MiddleEase = value; UpdateTexture(); }

		/// <summary>The strength of the color transition between the bottom and top.</summary>
		public float MiddleSharpness = 3.0f; public void SetMiddleSharpness(float value) { MiddleSharpness = value; UpdateTexture(); }

		/// <summary>The transition style between the bottom and middle.</summary>
		public SgtEase.Type BottomEase = SgtEase.Type.Exponential; public void SetBottomEase(SgtEase.Type value) { BottomEase = value; UpdateTexture(); }

		/// <summary>The transition strength between the bottom and middle.</summary>
		public float BottomSharpness = 1.0f; public void SetBottomSharpness(float value) { BottomSharpness = value; UpdateTexture(); }
