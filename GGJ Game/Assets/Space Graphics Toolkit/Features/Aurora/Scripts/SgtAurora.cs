...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtAurora : MonoBehaviour
	{
		...
		public Texture MainTex; public void SetMainTex(Texture value) { MainTex = value; UpdateMaterial(); }

		/// <summary>The base color will be multiplied by this.</summary>
		public Color Color = Color.white; public void SetColor(Color value) { Color = value; UpdateMaterial(); }

		/// <summary>The Color.rgb values are multiplied by this, allowing you to quickly adjust the overall brightness.</summary>
		public float Brightness = 1.0f; public void SetBrightness(float value) { Brightness = value; UpdateMaterial(); }
		...
		public SgtRenderQueue RenderQueue = SgtRenderQueue.GroupType.Transparent; public void SetRenderQueue(SgtRenderQueue value) { RenderQueue = value; UpdateMaterial(); }
		...
		public float CameraOffset; public void SetCameraOffset(float value) { CameraOffset = value; }
		...
		public float RadiusMin = 1.0f; public void SetRadiusMin(float value) { RadiusMin = value; UpdateMaterial(); }

		/// <summary>The inner radius of the aurora mesh in local space.</summary>
		public float RadiusMax = 1.1f; public void SetRadiusMax(float value) { RadiusMax = value; UpdateMaterial(); }

		/// <summary>The amount of aurora paths/ribbons.</summary>
		public int PathCount = 8; public void SetPathCount(int value) { PathCount = value; UpdateMeshesAndModels(); }

		/// <summary>The amount of quads used to build each path.</summary>
		public int PathDetail = 100; public void SetPathDetail(int value) { PathDetail = value; UpdateMeshesAndModels(); }

		/// <summary>The minimum length of each aurora path.</summary>
		[Range(0.0f, 1.0f)] public float PathLengthMin = 0.1f; public void SetPathLengthMin(float value) { PathLengthMin = value; UpdateMeshesAndModels(); }

		/// <summary>The maximum length of each aurora path.</summary>
		[Range(0.0f, 1.0f)] public float PathLengthMax = 0.1f; public void SetPathLengthMax(float value) { PathLengthMax = value; UpdateMeshesAndModels(); }

		/// <summary>The minimum distance between the pole and the aurora path start point.</summary>
		[Range(0.0f, 1.0f)] public float StartMin = 0.1f; public void SetStartMin(float value) { StartMin = value; UpdateMeshesAndModels(); }

		/// <summary>The maximum distance between the pole and the aurora path start point.</summary>
		[Range(0.0f, 1.0f)] public float StartMax = 0.5f; public void SetStartMax(float value) { StartMax = value; UpdateMeshesAndModels(); }

		/// <summary>The probability that the aurora path will begin closer to the pole.</summary>
		public float StartBias = 1.0f; public void SetStartBias(float value) { StartBias = value; UpdateMeshesAndModels(); }

		/// <summary>The probability that the aurora path will start on the northern pole.</summary>
		[Range(0.0f, 1.0f)] public float StartTop = 0.5f; public void SetStartTop(float value) { StartTop = value; UpdateMeshesAndModels(); }

		/// <summary>The amount of waypoints the aurora path will follow based on its length.</summary>
		[Range(1, 100)] public int PointDetail = 10; public void SetPointDetail(int value) { PointDetail = value; UpdateMeshesAndModels(); }

		/// <summary>The strength of the aurora waypoint twisting.</summary>
		public float PointSpiral = 1.0f; public void SetPointSpiral(float value) { PointSpiral = value; UpdateMeshesAndModels(); }

		/// <summary>The strength of the aurora waypoint random displacement.</summary>
		[Range(0.0f, 1.0f)] public float PointJitter = 1.0f; public void SetPointJitter(float value) { PointJitter = value; UpdateMeshesAndModels(); }

		/// <summary>The sharpness of the fading at the start and ends of the aurora paths.</summary>
		public float TrailEdgeFade = 1.0f; public void SetTrailEdgeFade(float value) { TrailEdgeFade = value; UpdateMeshesAndModels(); }

		/// <summary>The amount of times the main texture is tiled based on its length.</summary>
		public float TrailTile = 30.0f; public void SetTrailTile(float value) { TrailTile = value; UpdateMeshesAndModels(); }

		/// <summary>The flatness of the aurora path.</summary>
		[Range(0.1f, 1.0f)] public float TrailHeights = 1.0f; public void SetTrailHeights(float value) { TrailHeights = value; UpdateMeshesAndModels(); }

		/// <summary>The amount of height changes in the aurora path.</summary>
		public int TrailHeightsDetail = 10; public void SetTrailHeightsDetail(int value) { TrailHeightsDetail = value; UpdateMeshesAndModels(); }

		/// <summary>The possible colors given to the top half of the aurora path.</summary>
		public Gradient Colors { get { if (colors == null) colors = new Gradient(); return colors; } } [FormerlySerializedAs("Colors")] [SerializeField] private Gradient colors;

		/// <summary>The amount of color changes an aurora path can have based on its length.</summary>
		public int ColorsDetail = 10; public void SetColorsDetail(int value) { ColorsDetail = value; UpdateMeshesAndModels(); }

		/// <summary>The minimum opacity multiplier of the aurora path colors.</summary>
		[Range(0.0f, 1.0f)] public float ColorsAlpha = 0.5f; public void SetColorsAlpha(float value) { ColorsAlpha = value; UpdateMeshesAndModels(); }

		/// <summary>The amount of alpha changes in the aurora path.</summary>
		public float ColorsAlphaBias = 2.0f; public void SetColorsAlphaBias(float value) { ColorsAlphaBias = value; UpdateMeshesAndModels(); }

		/// <summary>Should the aurora fade out when the camera gets near?</summary>
		public bool Near; public void SetNear(bool value) { Near = value; UpdateMaterial(); }
		...
		public Texture NearTex; public void SetNearTex(Texture value) { NearTex = value; UpdateMaterial(); }

		/// <summary>The distance the fading begins from in world space.</summary>
		public float NearDistance = 2.0f; public void SetNearDistance(float value) { NearDistance = value; UpdateMaterial(); }

		/// <summary>Should the aurora paths animate?</summary>
		public bool Anim; public void SetAnim(bool value) { Anim = value; UpdateMaterial(); }

		/// <summary>The current age/offset of the animation.</summary>
		public float AnimOffset; public void SetAnimOffset(float value) { AnimOffset = value; }

		/// <summary>The speed of the animation.</summary>
		public float AnimSpeed = 1.0f; public void SetAnimSpeed(float value) { AnimSpeed = value; }

		/// <summary>The strength of the aurora path position changes in local space.</summary>
		public float AnimStrength = 0.01f; public void SetAnimStrength(float value) { AnimStrength = value; UpdateMeshesAndModels(); }

		/// <summary>The amount of the animation strength changes along the aurora path based on its length.</summary>
		public int AnimStrengthDetail = 10; public void SetAnimStrengthDetail(int value) { AnimStrengthDetail = value; UpdateMeshesAndModels(); }

		/// <summary>The maximum angle step between sections of the aurora path.</summary>
		public float AnimAngle = 0.01f; public void SetAnimAngle(float value) { AnimAngle = value; UpdateMeshesAndModels(); }

		/// <summary>The amount of the animation angle changes along the aurora path based on its length.</summary>
		public int AnimAngleDetail = 10; public void SetAnimAngleDetail(int value) { AnimAngleDetail = value; UpdateMeshesAndModels(); }
