...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtAuroraNearTex : MonoBehaviour
	{
		...
		public SgtEase.Type Ease = SgtEase.Type.Smoothstep; public void SetEase(SgtEase.Type value) { Ease = value; UpdateTexture(); }

		/// <summary>The sharpness of the transition.</summary>
		public float Sharpness = 1.0f; public void SetSharpness(float value) { Sharpness = value; UpdateTexture(); }
