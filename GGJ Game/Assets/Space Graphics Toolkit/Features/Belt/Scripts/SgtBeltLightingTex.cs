...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtBeltLightingTex : MonoBehaviour
	{
		...
		public float FrontPower = 2.0f; public void SetFrontPower(float value) { FrontPower = value; UpdateTexture(); }

		/// <summary>How sharp the incoming light scatters backward.</summary>
		public float BackPower = 3.0f; public void SetBackPower(float value) { BackPower = value; UpdateTexture(); }

		/// <summary>The strength of the back scattered light.</summary>
		[Range(0.0f, 1.0f)] public float BackStrength = 0.0f; public void SetBackStrength(float value) { BackStrength = value; UpdateTexture(); }

		/// <summary>The of the perpendicular scattered light.</summary>
		[Range(0.0f, 1.0f)] public float BaseStrength = 0.0f; public void SetBaseStrength(float value) { BaseStrength = value; UpdateTexture(); }
