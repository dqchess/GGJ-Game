...
namespace SpaceGraphicsToolkit
{
	...
	public abstract class SgtBelt : SgtQuads
	{
		...
		public float OrbitOffset; public void SetOrbitOffset(float value) { OrbitOffset = value; }

		/// <summary>The animation speed of this belt.</summary>
		public float OrbitSpeed = 1.0f; public void SetOrbitSpeed(float value) { OrbitSpeed = value; }
		...
		public bool PowerRgb; public void SetPowerRgb(bool value) { PowerRgb = value; UpdateMaterial(); }
