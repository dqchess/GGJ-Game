		...
		protected override void OnInspector()
		{
			...
			if (Any(t => t.Lit == true))
			{
				...
				BeginIndent();
					...
					EndError();
					DrawDefault("AmbientColor", ref updateMaterial, "The cloudsphere will always be lit by this amount.");
				EndIndent();
			}
...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtCloudsphere : MonoBehaviour
	{
		...
		public float Radius = 1.5f; public void SetRadius(float value) { Radius = value; UpdateModel(); }
		...
		public Cubemap MainTex; public void SetMainTex(Cubemap value) { MainTex = value; UpdateMaterial(); }
		...
		public Texture2D DepthTex; public void SetDepthTex(Texture2D value) { DepthTex = value; UpdateMaterial(); }

		/// <summary>Should the stars fade out if they're intersecting solid geometry?</summary>
		[Range(0.0f, 1000.0f)] public float Softness; public void SetSoftness(float value) { Softness = value; UpdateMaterial(); }
		...
		public bool Lit; public void SetLit(bool value) { Lit = value; UpdateMaterial(); }
		...
		public Texture LightingTex; public void SetLightingTex(Texture value) { LightingTex = value; UpdateMaterial(); }

		/// <summary>The cloudsphere will always be lit by this amount.</summary>
		public Color AmbientColor; public void SetAmbientColor(Color value) { AmbientColor = value; UpdateMaterial(); }
		...
		public float NearDistance = 1.0f; public void SetNearDistance(float value) { NearDistance = value; UpdateMaterial(); }

		/// <summary>Enable this if you want the cloud edges to be enhanced with more detail.</summary>
		public bool Detail; public void SetDetail(bool value) { Detail = value; UpdateMaterial(); }

		/// <summary>This allows you to set the detail map texture, the detail should be stored in the alpha channel.</summary>
		public Texture DetailTex; public void SetDetailTex(Texture value) { DetailTex = value; UpdateMaterial(); }

		/// <summary>This allows you to set how many times the detail texture is repeating along the cloud surface.</summary>
		public float DetailScale = 8.0f; public void SetDetailScale(float value) { DetailScale = value; UpdateMaterial(); }

		/// <summary>This allows you to set how many times the detail texture is repeating along the cloud surface.</summary>
		public float DetailTiling = 90.0f; public void SetDetailTiling(float value) { DetailTiling = value; UpdateMaterial(); }

		/// <summary>This allows you to set the mesh used to render the cloudsphere. This should be a sphere.</summary>
		public Mesh Mesh; public void SetMesh(Mesh value) { Mesh = value; UpdateModel(); }
		...
		public float MeshRadius = 1.0f; public void SetMeshRadius(float value) { MeshRadius = value; UpdateModel(); }
